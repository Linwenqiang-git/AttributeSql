...
{
    public class AttrSqlService<TDbContext> : IAttrSqlService<TDbContext> where TDbContext : IEfCoreDbContext,ITransientDependency
    {
        private readonly AttrSqlGenerator<TDbContext> _sqlGenerator;
        private readonly IMapper _mapper;
        public AttrSqlService(AttrSqlGenerator<TDbContext> sqlGenerator, IMapper mapper)
        {
        ...
        {
            return _sqlGenerator.DebugQuerySql<TResultDto, TPageSearch>(pageSearch, IngnorIntDefault, whereSql);
        }
            ...
            where TEntity : AttrEntityBase, new()
        {
            ...
            {
                var result = await _sqlGenerator.GetAll<TPageSearch, TEntity>(pageSearch, tableName);
                rm.Result = result;
            ...
            where TResultDto : AttrBaseResult, new()
        {
            ...
            return await TryCatch(async () =>
            {
                var result = await _sqlGenerator.GetSpecifyResultDto<TResultDto, TPageSearch>(pageSearch, IngnorIntDefault, whereSql, usingCache);
                rm.Result = result;
                rm.Total = result.Total;
                return rm;
            }, ErrorMsg);
            ...
            where TResult : AttrBaseResult, new()
        {
            ...
            return await TryCatch(async () =>
            {
                var result = await _sqlGenerator.ExecQuerySql<TResult>(sql);
                rm.Result = result;
                rm.Total = result.Total;
                return rm;
            }, ErrorMsg);
            ...
            where TResult : AttrBaseResult, new()
        {
            try
            {
                return await _sqlGenerator.ExecQuerySqlInside<TResult>(sql);
            }
            catch (Exception ex)
            {
            ...
            where TEntity : AttrEntityBase, new()
        {
            ...
            return await TryCatch(async () =>
            {
                ...
                await _sqlGenerator.Delete(entity);
                rm.Result = true;
                return rm;
            }, ErrorMsg);
        }
            ...
            where TEntity : AttrEntityBase, new()
        {
            ...
            {
                var entity = _mapper.Map<TEntity>(DtoModel);
                rm.Result = await _sqlGenerator.Delete(entity, condition);
                return rm;
            }, ErrorMsg);
        }
            ...
            where TEntity : AttrEntityBase, new()
        {
            ...
            {
                var entity = _mapper.Map<TEntity>(DtoModel);
                rm.Result = await _sqlGenerator.SoftDelete(entity, softDeleteField, value, PrimaryKey, IngnorIntDefault);
                return rm;
            }, ErrorMsg);
        }
            ...
            where TEntity : AttrEntityBase, new()
        {
            ...
            return await TryCatch(async () =>
            {
                var entity = _mapper.Map<TEntity>(DtoModel);
                //校验名称是否重复
                if (await _sqlGenerator.CheckFieldRepeat(DtoModel, 0))
                {
                    // 执行添加
                    var rows = await _sqlGenerator.InsertAsync(entity);
                    if (rows == 0)
                    {
                        rm.Code = ResultCode.UnknownError;
                        rm.Msg = "创建数据失败!";
        ...
        public async Task<AttrResultModel> NonPatameterBatchInsertAsync<TEntity>(TEntity[] Entities, string ErrorMsg) where TEntity : AttrEntityBase, new()
        {
            ...
            return await TryCatch(async () =>
            {
                ...
                {
                    // 执行添加
                    rm.Result = await _sqlGenerator.NonPatameterBatchInsertAsync(Entities);
                }
                return rm;
            }, ErrorMsg);
        }
            ...
            where TEntity : AttrEntityBase, new()
        {
            ...
            return await TryCatch(async () =>
            {
                ...
                //校验名称是否重复
                if (await _sqlGenerator.CheckFieldRepeat(DtoModel, 1))
                {
                    // 执行更新
                    if (UpdateByKey)
                        rm.Result = await _sqlGenerator.UpdateHasValueField(entity, PrimaryKey, IgnorIntDefault);
                    else
                        rm.Result = await _sqlGenerator.UpdateHasValueFieldByDto(DtoModel, entity, IgnorIntDefault);
                }
                return rm;
            }, ErrorMsg);
        }
            ...
            where TEntity : AttrEntityBase, new()
        {
            ...
            return await TryCatch(async () =>
            {
                ...
                {
                    // 执行更新
                    rm.Result = await _sqlGenerator.UpdateField(entity, PrimaryKey, IgnorIntDefault);
                }
                return rm;
            }, ErrorMsg);
        }
        ...
        public async Task<AttrResultModel> UpdateAsync<TDto>(TDto dto, string ErrorMsg = "", bool IgnorIntDefault = true) where TDto : AttrBaseModel, new()
        {
            ...
            {
                // 执行更新
                rm.Result = await _sqlGenerator.UpdateDtoAttributeField(dto, IgnorIntDefault);
                return rm;
            }, ErrorMsg);
        }
        /// <summary>
                ...
                where TEntity : AttrEntityBase, new()
        {
            ...
            return await TryCatch(async () =>
            {
                rm.Result = await _sqlGenerator.ExecUpdateSql(entity, sql);
                return rm;
            }, ErrorMsg);
        }
        #endregion
